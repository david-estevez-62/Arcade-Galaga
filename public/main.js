...
function preload() {
  ...
  game.scale.refresh();
    ...
    game.load.image('logo', './assets/logogalaga6.png');
   

    game.load.audio('laser', './assets/LaserGun.mp3')
    game.load.audio('thruster', './assets/thruster.wav')
    game.load.audio('explosion', './assets/explosion.mp3')



    game.load.spritesheet('kaboom', './assets/explode.png', 128, 128);
    game.load.spritesheet('aliens1', './assets/spritsheet04.png', 28, 28);
    game.load.image('enemyBullet', './assets/enemy-bullet.png')
    game.load.image('button2', './assets/game-over.png')
}
...
function create() {
		...
		//  The score
		scoreString = 'Score : ';
		scoreText = game.add.text(10, 10, scoreString + score, { font: '22px starjedi', fill: '#fff' });
